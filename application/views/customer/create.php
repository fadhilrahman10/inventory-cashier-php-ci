          ...
          >
            <div class="container-fluid">
              <div class="dashboard-heading">
                <h2 class="dashboard-title">Add New Customer</h2>
                <p class="dashboard-subtitle">Create your Customer</p>
              </div>
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <input
                                  ...
                                  aria-describedby="id"
                                  name="id_customer"
                                  value="<?=set_value('id_customer', $kode);?>"
                                  readonly
                                />
