          ...
          >
            <div class="container-fluid">
              <div class="dashboard-heading">
                <h2 class="dashboard-title">#<?=$data['no_penjualan'];?></h2>
                          ...
                          <div class="col-12 col-md-8">
                            <div class="row">
                              <div class="col-12 col-md-6">
                                ...
                                <div class="product-subtitle"><?=$data['nama_customer'];?></div>
                              </div>
                              <div class="col-12 col-md-6">
                          ...
                          <div class="col-12 mt-4">
                            ...
                            <div class="row">
                              ...
                              <div class="col-12 col-md-6">
                                ...
                                <div class="product-subtitle <?=$data['status'] == 'sudah' ? 'text-success' : 'text-danger';?>">
                                  <?=$data['status'] == 'sudah' ? 'SUCCESS' : 'BELUM BAYAR';?>
                                </div>
                              </div>
                              <div class="col-12">
                                <div class="row">
