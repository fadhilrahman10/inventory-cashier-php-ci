        ...
        <script>
          function show(data) {
            ...
            for (let i = 0; i < data.length; i++) {
              ...
              // baris += '<a class="card card-list -block" href="<?= base_url('cashier'); ?>/detail/' + data[i].no_penjualan + '">' +
              //   '<div class="card-body">' +
              //   '<div class="row">' +
              ...
              baris += `
                <a href="<?= base_url('cashier'); ?>/detail/${data[i].no_penjualan}" class="card card-list-block">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-1"></div>
                      <div class="col-md-4">${data[i].nama_barang}</div>
                      <div class="col-md-3"></div>
                      <div class="col-md-3" id="${i+1}"></div>
                      <div class="col-md-1 d-none d-md-block">
                        <img src="<?= base_url(); ?>assets/images/dashboard-arrow-right.svg" alt="" />
                      </div>
                    </div>
