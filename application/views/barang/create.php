...
>
    <div class="container-fluid">
        <div class="dashboard-heading">
            <h2 class="dashboard-title">Add New Barang</h2>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                name="id_barang"
                                                value="<?=set_value('id_barang', $kode);?>"
                                                readonly
                                            />
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="validationServer03">Nama Barang</label>
                                            <input
                                                type="text"
                                                class="form-control <?php if (validation_errors() != ''): ?>
